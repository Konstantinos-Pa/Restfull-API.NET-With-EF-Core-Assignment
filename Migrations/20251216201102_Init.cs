        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NativeLanguage = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssessmentResultLabel = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_Candidates_CandidateNumber",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateOnly>(type: "date", nullable: true, defaultValueSql: "CURRENT_DATE"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MobileNumber = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                    MobileType = table.Column<string>(type: "text", nullable: true),
                    CandidateNumber = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mobiles_Candidates_CandidateNumber",
                        column: x => x.CandidateNumber,
                        principalTable: "Candidates",
                        principalColumn: "CandidateNumber",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_photoIds_Candidates_CandidateNumber",
                        column: x => x.CandidateNumber,
                        principalTable: "Candidates",
                        principalColumn: "CandidateNumber",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CertificateCandidates", x => new { x.CandidatesCandidateNumber, x.CertificatesId });
                    table.ForeignKey(
                        name: "FK_CertificateCandidates_Candidates_CandidatesCandidateNumber",
                        column: x => x.CandidatesCandidateNumber,
                        principalTable: "Candidates",
                        principalColumn: "CandidateNumber",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CertificateCandidates_Certificates_CertificatesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_CandidateNumber",
                table: "Addresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificateCandidates_CertificatesId",
                table: "CertificateCandidates",
                column: "CertificatesId");

            migrationBuilder.CreateIndex(
                name: "IX_Mobiles_CandidateNumber",
                table: "Mobiles",
                column: "CandidateNumber");

            migrationBuilder.CreateIndex(
                name: "IX_photoIds_CandidateNumber",
                table: "photoIds",
                column: "CandidateNumber",
                unique: true);
        }
